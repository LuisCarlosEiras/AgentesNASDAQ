...
if st.button("Analisar"):
    ...
    if ticker:
        ...
        with st.spinner("Buscando os Dados em Tempo Real. Aguarde..."):
            ...
            ai_response = multi_ai_agent.run(f"1 - Resumir a recomendação do analista,
            2 - compartilhar as últimas notícias para {ticker} incluindo as consequências do tarifaço do Trump
            3 - e prever as variações da ação nos próximos 3 meses")
